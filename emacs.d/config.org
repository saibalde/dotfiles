...
#+begin_src emacs-lisp
  (use-package org
    ...
    (setq org-capture-templates
          '(("t" "Task" entry
             (file "~/OrgFiles/tasks/inbox.org")
             "* TODO %?\nAdded: %U")
            ("m" "Meeting" entry
             (file "~/OrgFiles/tasks/inbox.org")
             "* %?\n%T")))

    (setq org-agenda-files (list "~/OrgFiles/tasks"
                                 "~/OrgFiles/projects"))
...
#+begin_src emacs-lisp
  ...
  (use-package ivy-bibtex
    ...
    (setq bibtex-completion-bibliography "~/OrgFiles/references/references.bib")
    (setq bibtex-completion-library-path "~/OrgFiles/references/pdfs/")
    (setq bibtex-completion-pdf-field "file")
    (setq bibtex-completion-notes-path "~/OrgFiles/references/notes")
