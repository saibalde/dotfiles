...
#+begin_src emacs-lisp
  (use-package org
    ...
    (setq org-capture-templates
          '(("t" "Task" entry
             (file+headline "~/OrgFiles/tasks.org" "Inbox")
             "* TODO %?\nAdded: %U")
            ("m" "Meeting" entry
             (file+headline "~/OrgFiles/tasks.org" "Calendar")
             "* %?\n%T")))
...
#+begin_src emacs-lisp
  ...
  (use-package ivy-bibtex
    ...
    (setq bibtex-completion-bibliography "~/OrgFiles/references.bib")
    (setq bibtex-completion-library-path "~/OrgFiles/pdfs/")
    (setq bibtex-completion-pdf-field "file")
    (setq bibtex-completion-notes-path "~/OrgFiles/notes/")
